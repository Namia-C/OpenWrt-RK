...
# 如果你不懂不要瞎碰，我更改完后已经够你用了，你不懂并且你不够用或者缺啥邮箱或者提交问题我弄或者tG群联系我------------------------------------
...
git_sparse_clone dev https://github.com/muink/luci-app-netspeedtest luci-app-netspeedtest librespeed-go
